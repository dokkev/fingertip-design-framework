...
from lumo.mesh.rigid.object import RigidObjectMesh, RigidPose3D

from .fingertip_adapter import PreparedFingertipMesh
from ..contracts.types import NewtonResult
from ..newton.solve import NewtonSettings, _load_newton_backend

if TYPE_CHECKING:
    from lumo.contact.first_contact import FirstContactResult
